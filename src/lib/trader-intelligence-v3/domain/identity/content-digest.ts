...
export type ContentIdentityDomain =
  ...
  | "trade_query_result"
  | "trade_query_execution_receipt"
  | "persisted_trade_query"
  | "trade_query_evidence_retrieval"
  | "trade_query_similarity_search"
